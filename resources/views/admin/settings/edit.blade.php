                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small class="text-muted">Use the real shared S3 bucket name only. HHMS files save inside {{ trim(config('hhms.s3_prefix', 'HHMS'), '/') }}/ automatically.</small>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="alert alert-light border mt-3 mb-0">
                                Select S3 only after the bucket exists in AWS and the region/keys are correct. File folders are created inside the HHMS main folder automatically.
                            </div>
                        </div>
                    </div>
                </div>
