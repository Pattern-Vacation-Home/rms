...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'dtcm_fee_studio' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_1_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_2_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_3_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_4_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_5_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_6_bhk' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_penthouse' => 'nullable|numeric|min:0|max:999999',
            'dtcm_fee_villa' => 'nullable|numeric|min:0|max:999999',
